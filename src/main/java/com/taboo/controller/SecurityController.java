...
import com.taboo.db.taboo_db.entity.User;
import com.taboo.db.taboo_db.service.SecurityService;

@RestController
@PropertySource("classpath:${configfile.path}/Taboo.properties")
